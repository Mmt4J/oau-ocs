        ...
        <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="edit_admin" method="post">
                    
                  <input type="hidden" name="id" value="<?php echo $id; ?>" id="title">

                    <div class="form-group">
                      <label for="username">Username</label>
                      <input type="text" name="username" class="form-control" id="exampleInputUsername1" value="<?php echo $username; ?>">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" name="password" class="form-control" id="exampleInputEmail1" value="<?php echo $password; ?>">
                    </div>

                    <div class="form-group">
                      <label for="passwordC">Password Confirmation</label>
                      <input type="password" name="passwordC" class="form-control" id="exampleInputEmail1" value="<?php echo $passwordC; ?>"placeholder="Confirm password">
                    </div>

                    <button type="submit" name="update-admin" class="btn btn-primary me-2">Submit</button>
