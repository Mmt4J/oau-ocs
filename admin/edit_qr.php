    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Edit Q & R</h4>
                  <p class="card-description">
                    <!-- Basic form layout -->
                  </p>
                  <form action="edit_qr" method="post" class="forms-sample">

                    <input type="hidden" name="id" value="<?php echo $id; ?>" id="title">

                    <div class="form-group">
                      <label for="message">Message</label>
                      <input type="text" name="messages" class="form-control" id="exampleInputUsername1" value="<?php echo $message; ?>">
                    </div>
                    <div class="form-group">
                      <label for="response">Response</label>
                      <input type="text" name="response" class="form-control" id="exampleInputEmail1" value="<?php echo $response; ?>">
                    </div>

                    <button type="submit" name="update-qr" class="btn btn-primary me-2">Submit</button>
